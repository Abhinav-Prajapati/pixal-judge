...
Image schemas moved to src.images.schemas - re-exported here for backward compatibility.
"""
from datetime import datetime
from pydantic import BaseModel, ConfigDict
from typing import List, Dict, Any, Optional

# Import image schemas from new location for backward compatibility
from src.images.schemas import ImageResponse, Metadata, ImageQualityRequest, ImageQualityResponse

# Re-export for backward compatibility
__all__ = ['ImageResponse', 'Metadata', 'ImageQualityRequest', 'ImageQualityResponse',
           'GroupAssociationResponse', 'BatchCreate', 'BatchRename', 'BatchAnalyze',
           'BatchUpdateImages', 'BatchResponse', 'BatchGroupUpdate']
