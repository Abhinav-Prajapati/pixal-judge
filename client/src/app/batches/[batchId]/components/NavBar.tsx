...
export function NavBar() {
  ...
  const renameMutation = useMutation({
    ...
    onSuccess: (data) => {
      // Manually update the Zustand store or invalidate a query
      // Here, we invalidate the query to force a refetch and keep TanStack Query as the source of truth
      if (batch) {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      // Navigate to the batches list after successful deletion
